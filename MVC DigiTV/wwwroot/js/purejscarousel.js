...
(function() {
    ...
    PureJSCarousel.prototype.build = function() {
        ...
        if (_.infinite === true) {
            _.currentXPos = -((_.slides[0].offsetWidth + slidePadding) * _.slides.length);
            _.slidesContainer.style.transform = "translateX(" + _.currentXPos + "px)";
            _.slidesContainer.style.width = (_.slides[0].offsetWidth + slidePadding) * _.slides.length * 3 + "px";
        } else {
            _.currentXPos = 0;
            _.slidesContainer.style.transform = "translateX(0px)";
            _.slidesContainer.style.width =
                (_.slides[0].offsetWidth + slidePadding) * _.slides.length + "px";
        }
        ...
        if ("ontouchstart" in window || navigator.maxTouchPoints) {
            ...
            _.slidesContainer.addEventListener("touchend", function() {
                var direction =
                    ...
                    blockWidth =
                    _.oneByOne === true ?
                    (_.slides[0].offsetWidth + slidePadding) :
    ...
    PureJSCarousel.prototype.goToSlide = function(n, dir, trigger) {
        var _ = this,
            ...
            blockWidth =
            this.oneByOne === true ?
            (this.slides[0].offsetWidth + slidePadding) :
